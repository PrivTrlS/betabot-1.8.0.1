...
<head>        
        <!-- META SECTION -->
        <title>iSpy Premium - View Log</title>            
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <?php if ($type == 1) { ?><a href="../logs"><?php } else if ($type == 2) { ?><a href="../stealer"><?php } else if ($type == 3) { ?><a href="../pinlogger"><?php } else if ($type == 4) { ?><a href="../screenshot"><?php } else if ($type == 5) { ?><a href="../webcamsnap"><?php } ?><button type="button" class="btn btn-success"><i class="fa fa-arrow-circle-left"></i> Back To Logs</button></a>
                                </div>
                            </div>
                        </div>
                    </div>             
