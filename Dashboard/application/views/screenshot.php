...
<head>        
        <!-- META SECTION -->
        <title>iSpy Premium - Screenshot Logger</title>            
        ...
        $(document).ready(function() {
            $('#tblKeystrokes').DataTable( {
                  "processing": true,
                  "serverSide": true,
                  "ajax": "<?php echo base_url();?>getscreenshots"
             });
        });
        </script>         
        <!-- EOF CSS INCLUDE -->            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Screenshot Logger</li>
                </ul>
                <!-- END BREADCRUMB -->                
                
                <div class="page-title">                    
                    <h2><span class="fa fa-keyboard-o"></span>Screenshot Logger</h2>
                </div>                   
                    ...
                    <div class="row">
                        <div class="col-md-4">
                                <div class="list-group border-bottom">
                                    ...
                                    <a href="screenshot" class="list-group-item active">Screenshot Logger<span class="badge badge-primary"><?php echo $this->security->xss_clean($screenshot_log_amount); ?></span></a>
                                    ...
                                    <a href="stealer" class="list-group-item">250+ Recoveries <span class="badge badge-primary"><?php echo $this->security->xss_clean($stealer_log_amount); ?></span></a>  
                        ...
                        <div class="col-md-8">
                                <?php if (!$logs) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <center>You don't currently have any Screenshots. A table will be generated when you receive your first log.</center>
                                    </div>
                                <?php } else { ?>
