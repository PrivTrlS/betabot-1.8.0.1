...
<head>        
        <!-- META SECTION -->
        <title>iSpy Premium - Dashboard</title>            
        ...
        <script type="text/javascript">    
			...
			$(function () {
    			$('#computers').highcharts({
        			...
        			series: [{
        			name: 'Win 98',
            			data: [<?php echo $this->security->xss_clean($logstoday98); ?>, <?php echo $this->security->xss_clean($logsyesterday98); ?>, <?php echo $this->security->xss_clean($logs2daysago98); ?>, <?php echo $this->security->xss_clean($logs3daysago98); ?>, <?php echo $this->security->xss_clean($logstotal98); ?>]
        			}, {
            			name: 'XP',
				...
				name: 'Win 8.1',
            			data: [<?php echo $this->security->xss_clean($logstoday81); ?>, <?php echo $this->security->xss_clean($logsyesterday81); ?>, <?php echo $this->security->xss_clean($logs2daysago81); ?>, <?php echo $this->security->xss_clean($logs3daysago81); ?>, <?php echo $this->security->xss_clean($logstotal81); ?>]
        			}, {
				name: 'Win 10',
            			data: [<?php echo $this->security->xss_clean($logstoday10); ?>, <?php echo $this->security->xss_clean($logsyesterday10); ?>, <?php echo $this->security->xss_clean($logs2daysago10); ?>, <?php echo $this->security->xss_clean($logs3daysago10); ?>, <?php echo $this->security->xss_clean($logstotal10); ?>]
        			}, {
        			name: 'N/A',
